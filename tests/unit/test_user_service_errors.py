...
from src.schemas.users import UserCreate, UserReplace, UserUpdate
...
async def test_update_user_patch_user_not_found_after_update(db_session: AsyncSession, monkeypatch):
    ...
    monkeypatch.setattr("src.db.repositories.user_repository.update_user_partial", mock_update_user_partial)
...
async def test_replace_user_put_user_not_found_after_replace(db_session: AsyncSession, monkeypatch):
    ...
    monkeypatch.setattr("src.db.repositories.user_repository.replace_user", mock_replace_user)
...
async def test_delete_user_user_not_found_after_delete(db_session: AsyncSession, monkeypatch):
    ...
    monkeypatch.setattr("src.db.repositories.user_repository.delete_user", mock_delete_user)
